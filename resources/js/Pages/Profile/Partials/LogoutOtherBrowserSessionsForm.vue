...
<template>
    <ActionSection>
        <template #title>
            Sessiones en otros Navegadores
        </template>

        <template #description>
           Administra todas las sesiones que tienes activas en cualquier dispositivo
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Si es necesario puedes cerrar todas las sesiones desde tu dispositivo de confianza
